...
import Candle from "@/components/products/Candel";
import { CandleInterface } from "@/interface/CandleInterface";
import CandleData from "@/data/candelData.json";

export default function CandlePage() {
	const [products, setProducts] = useState<CandleInterface[]>([]);

	useEffect(() => {
		// Simulate fetching data from a local file
		setProducts(CandleData);
	}, []);
