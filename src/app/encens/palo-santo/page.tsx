...
import EncensPaloSanto from "@/components/products/encens/EncensPaloSanto";
import { EncensInterface } from "@/interface/EncensInterface";
import EncensPaloDantoData from "@/data/encens/encensPaloSanto.json";

export default function EncensPaloSantoPage() {
	const [products, setProducts] = useState<EncensInterface[]>([]);

	useEffect(() => {
		// Simulate fetching data from an API or a file
		setProducts(EncensPaloDantoData);
	}, []);
	...
	return (
		<main className="bg-white py-12">
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
				...
				<EncensPaloSanto products={products} />
			</div>
		</main>
	);
}
