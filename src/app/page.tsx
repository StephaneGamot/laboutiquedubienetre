...
export default function Home() {
  const [products, setProducts] = useState<Product[]>(HeroData as Product[]);
  const [error, setError] = useState<string | null>(null);

  useEffect(() => {
    // No need to fetch, data is imported directly
    setProducts(HeroData as Product[]);
  }, []);
    ...
    <main className="bg-white py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-4 max-w-2xl text-lg text-emerald-700 mx-auto">
          Découvrez notre collection de produits spirituels et de méditation, soigneusement sélectionnés pour votre bien-être.
        </p>
