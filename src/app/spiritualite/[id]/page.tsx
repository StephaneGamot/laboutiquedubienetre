...
import SpiritualityData from '@/data/spiritualityData.json';
...
export default function ProductDetailsPage() {
  ...
  const [product, setProduct] = useState<SpiritualityInterface | null>(null);
  const [selectedColor, setSelectedColor] = useState<string | undefined>(""); 

  useEffect(() => {
    if (id) {
      const foundProduct = SpiritualityData.find((p) => p.id === parseInt(id, 10));
