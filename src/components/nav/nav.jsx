...
import Bol from "./../../../public/Images/bol-tibetain.svg"
import Boucles from "./../../../public/Images/boucle-oreille.svg"
import Bougie from "./../../../public/Images/bougie.svg"
import Crystal from "./../../../public/Images/crystal.svg"
import Encens from "./../../../public/Images/encens.svg"
import Sante from "./../../../public/Images/santé.svg"
import Sauge from "./../../../public/Images/sauge.svg"
import Vision from "./../../../public/Images/vision.svg"

const products = [
    { name: 'Bols tibétains', description: 'Get a better understanding of your traffic', href: '#', icon: Bol },
  { name: 'Encens', description: 'Speak directly to your customers', href: '#', icon: Encens },
  { name: 'Sauge', description: 'Your customers’ data will be safe and secure', href: '#', icon: Sauge },
  { name: 'Bougies', description: 'Connect with third-party tools', href: '#', icon: Bougie },
  { name: 'Bijoux', description: 'Build strategic funnels that will convert', href: '#', icon: Boucles },
  { name: 'Spiritualité', description: 'Build strategic funnels that will convert', href: '#', icon: Vision },
  { name: 'Vie saine', description: 'Build strategic funnels that will convert', href: '#', icon: Sante},
  { name: 'Pierres minérales', description: 'Build strategic funnels that will convert', href: '#', icon: Crystal },
